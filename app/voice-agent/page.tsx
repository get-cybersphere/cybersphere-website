...
const NUMBER_CARDS: NumberCard[] = [
  {
    ...
    description: (
      <>
        Pinnacle Dental Group (TX) let{" "}
        <strong className="text-text-primary">
          AI follow up on every missed call
        </strong>{" "}
        within 30 seconds — converting 38% of previously lost calls into
  ...
  },
  {
    ...
    description: (
      <>
        Across 7,200+ calls last quarter, the AI answered in under two seconds —
        before most humans even reach the phone.{" "}
        <strong className="text-text-primary">
      ...
      <section className="min-h-screen bg-white rounded-[20px] relative overflow-hidden flex flex-col">
        ...
        <div className="absolute inset-0 flex items-center justify-center md:justify-end md:pr-[8%] pointer-events-none">
          <div className="hero-enter hero-enter-d1">
            <img
              src="/images/backgrounds/voice.png"
              alt=""
              className="hero-float w-[min(520px,65vw)] h-auto rotate-[-42deg]"
            />
          </div>
        </div>
          ...
          <div className="flex justify-between items-start">
            <div className="hidden lg:flex flex-col gap-8">
              ...
              <div>
                ...
                <p className="text-[13px] text-text-body leading-relaxed max-w-[180px]">
                  Qualifies leads, books appointments, handles FAQs
                </p>
              </div>
            </div>
        ...
        <div className="relative z-10 max-w-[1376px] w-full mx-auto px-4 md:px-8 pb-10 md:pb-16">
          <div className="hero-enter hero-enter-d2">
            ...
            >
              Never Miss
              <br />
              <span className="text-blue">Another</span>
              <br />
              Call
            </h1>
          </div>
      ...
      <section className="bg-bg-gray">
        <FadeUp className="max-w-[1376px] mx-auto px-4 md:px-8 py-16 md:py-24">
          ...
          <p className="text-text-body text-lg mb-12 max-w-2xl leading-relaxed">
            Measurable outcomes from businesses that switched to an AI voice
            agent.
          </p>
        ...
        <FadeUp className="max-w-[1376px] mx-auto px-4 md:px-8 py-16 md:py-24">
          <div className="flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-5/12 order-2 lg:order-1">
              <h2 className="mb-8">From Setup to Live in Under a Day</h2>
              <div className="space-y-5 text-text-body text-[16px] leading-[1.6]">
                <p>
                  Point us to your website. Our system scans your{" "}
                  <span className="font-semibold text-text-primary">
                    services, hours, and pricing
                  </span>{" "}
                  then builds a fully trained voice agent tailored to your
                  business — ready to take calls the same afternoon.
                </p>
                <p>
                  Every call is picked up instantly. The AI handles FAQs,
                  qualifies new leads, books directly into your{" "}
                  <span className="font-semibold text-text-primary">
                    calendar or CRM
                  </span>
                  , and routes complex requests to your team with a full
                  conversation summary.
                </p>
                <p>
                  No scripts to write. No phone trees to configure. Just connect
                  your number and let the agent work.
                </p>
              </div>
            </div>
