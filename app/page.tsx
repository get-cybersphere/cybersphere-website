...
const SOLUTIONS: Solution[] = [
  {
    ...
    description:
      "24/7 intelligent call answering that qualifies leads, books appointments, and recovers missed calls.",
    path: "/voice-agent",
  },
  {
    icon: Target,
    ...
    description:
      "Automated lead capture, rapid outbound follow-up, and funnel optimization. Turn interest into revenue.",
    path: "/lead-gen",
  },
  {
    icon: UserCheck,
    ...
    description:
      "Workflow automation that replaces repetitive admin, CRM management, and manual computer work.",
    path: "/ai-employee",
  },
  {
    icon: Shield,
    ...
    title: "AI Pentesting",
    description:
      "Proactive security testing and hardening for your AI systems. Identify vulnerabilities early.",
    path: "/pentesting",
  },
];
...
const PROCESS: ProcessItem[] = [
  {
    ...
    description:
      "Map workflows, identify revenue leaks, define measurable objectives.",
  },
  {
    icon: Layers,
    title: "System Architecture",
    description:
      "Design custom AI stack for your tech environment and business rules.",
  },
  {
    icon: Plug,
    title: "Build & Integration",
    description:
      "Build and integrate into existing tools (CRM, phones, calendars, ads) with zero disruption.",
  },
  {
    icon: Rocket,
    title: "Launch & Optimize",
    description:
      "Deploy, monitor KPIs, iterate until measurable improvement is achieved.",
  },
];
...
const TESTIMONIALS: Testimonial[] = [
  {
    quote:
      "Since deploying the AI voice agent, we've recovered an average of 47 missed calls per week. That's bookings we were simply leaving on the table.",
    name: "Sarah Mitchell",
  ...
  {
    quote:
      "The lead gen engine cut our average response time from 4 hours to 90 seconds. Our conversion rate went from 8% to 23% in the first quarter.",
    name: "Marcus Chen",
  ...
  {
    quote:
      "We replaced two full-time admin roles with the AI employee system. It handles scheduling, follow-ups, and CRM updates without a single error.",
    ...
    <div className="flex flex-col gap-1.5 p-1.5">
        ...
        <div className="absolute inset-0 flex items-center justify-center md:justify-end md:pr-[8%] pointer-events-none">
          <div className="hero-enter hero-enter-d1">
            <img
              ...
              alt=""
              className="hero-float w-[min(520px,65vw)] h-auto -rotate-[22deg]"
            />
          </div>
        </div>
            ...
            <div className="hidden lg:flex flex-col gap-8">
              <div>
                ...
                <p className="text-[13px] text-text-body leading-relaxed max-w-[180px]">
                  Custom systems for calls, leads & operations
                </p>
              </div>
              <div>
                <p className="text-[11px] font-medium uppercase tracking-[0.15em] text-text-muted mb-1">
                ...
                <p className="text-[13px] text-text-body leading-relaxed max-w-[180px]">
                  Discovery to deployment, fully managed
                </p>
              </div>
            </div>
        ...
        <div className="relative z-10 max-w-[1376px] w-full mx-auto px-4 md:px-8 pb-10 md:pb-16">
          <div className="hero-enter hero-enter-d2">
            ...
            >
              AI Systems
              <br />
              <span className="text-blue">Built for</span>
              <br />
              Business
            </h1>
          </div>
      ...
      <FadeUp className="grid lg:grid-cols-2 gap-1.5">
        <div className="bg-white rounded-[20px] p-8 md:p-12 flex flex-col items-center relative overflow-hidden">
          ...
          <div className="flex-1" />
          <img
            src="/images/backgrounds/offerings.png"
            alt=""
            className="absolute bottom-0 left-0 w-[75%] max-w-[320px] h-auto pointer-events-none"
          />
        </div>
          ...
          {SOLUTIONS.map((sol, i) => {
            ...
            return (
              <Link
                key={sol.path}
                href={sol.path}
                className={`${featured ? "flex-[1.5]" : "flex-1"} rounded-[20px] p-7 md:p-8 flex flex-col justify-between group transition-colors relative overflow-hidden ${
                  featured
                    ? "bg-blue text-white"
              ...
              >
                <h3
                  className={`font-heading font-bold uppercase text-[22px] md:text-[26px] leading-[1.1] tracking-[-0.01em] relative z-10 ${
                ...
                <div className="flex items-end justify-end gap-3 relative z-10">
                  <p
                    className={`text-[11px] font-medium uppercase tracking-[0.06em] text-right max-w-[260px] leading-[1.6] ${
                ...
                {i === 1 && (
                  <img
                    ...
                    alt=""
                    className="absolute bottom-0 left-0 w-[45%] max-w-[180px] h-auto pointer-events-none opacity-90"
                  />
                )}
                {i === 3 && (
                  <img
                    ...
                    alt=""
                    className="absolute top-0 left-1/2 -translate-x-1/2 w-[45%] max-w-[180px] h-auto pointer-events-none opacity-90"
                  />
                )}
              </Link>
            );
        ...
        <div className="bg-white rounded-[20px] p-8 md:p-10 lg:p-12">
          <div className="flex flex-col-reverse md:flex-row justify-between items-start gap-6">
            <p className="text-[11px] md:text-[12px] font-medium uppercase tracking-[0.1em] text-text-muted max-w-[340px] leading-[1.8]">
              Every engagement is custom. Deep operational discovery, custom
              architecture, seamless integration, and measurable results.
            </p>
            <h2
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1.5 mt-1.5">
          {PROCESS.map((step, i) => {
            ...
            return (
              <div
                key={i}
                className={`rounded-[20px] p-6 md:p-8 flex flex-col min-h-[340px] md:min-h-[400px] ${
                  featured ? "bg-blue text-white" : "bg-white"
                }`}
              >
                <h3
                  className={`font-heading font-bold uppercase text-[20px] md:text-[22px] leading-[1.1] tracking-[-0.01em] text-center ${
                    featured ? "text-white" : "text-text-primary"
                  }`}
                >
                  {step.title}
                ...
                <div className="flex-1 flex items-center justify-center py-6">
                  <step.icon
                    className={`w-16 h-16 md:w-20 md:h-20 ${
                      featured ? "text-white/80" : "text-blue"
                    }`}
                    strokeWidth={1}
                  />
                </div>
                <p
                  className={`text-[11px] font-medium uppercase tracking-[0.06em] leading-[1.7] ${
                    featured ? "text-white/70" : "text-text-muted"
                  }`}
                >
                  {step.description}
